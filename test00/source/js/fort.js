var Fort = {
    ...
    sections: function() {
        ...
        t1.innerHTML = '<div class="top-one" id="top1"><div class="colors"></div></div>';
        ...
        function generateCSSGradient(colours) {
            ...
            return "linear-gradient( to left, " + colours.join(", ") + ")";
        }
        ...
        var window_width = document.querySelector(".colors") + "px";
